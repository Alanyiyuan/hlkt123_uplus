 ...
 * 
 * @ClassName: HttpUtil
 * @Description: TODO(发送请求类)
 * @author 赵卓
 * @date 2014-4-11 下午2:14:36
 * 
 */
...
public class HttpUtil {
	...
	private static HttpClient getNewHttpClient() {
		try {
			...
			HttpConnectionParams.setConnectionTimeout(params, 10000);//设置请求超时时间
			HttpConnectionParams.setSoTimeout(params, 30000);//读取超时
